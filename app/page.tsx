...
import { SoberanosArsCerTable } from "@/components/soberanos-ars-cer-table"
import { SoberanosArsFijaTable } from "@/components/soberanos-ars-fija-table"
import { SoberanosArsTamarTable } from "@/components/soberanos-ars-tamar-table"
        ...
        {data && (
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="CER" className="space-y-6">
              ...
              <SoberanosArsCerTable flows={filteredDetailsData} activeTab={activeTab} />
            </TabsContent>
            <TabsContent value="Fija" className="space-y-6">
              <SoberanosArsDetailsFilters monedas={data.monedas} emisores={data.emisores} onFiltersChange={handleDetailsFiltersChange} />
              <SoberanosArsFijaTable flows={filteredDetailsData} activeTab={activeTab} />
            </TabsContent>
            <TabsContent value="TAMAR" className="space-y-6">
              <SoberanosArsDetailsFilters monedas={data.monedas} emisores={data.emisores} onFiltersChange={handleDetailsFiltersChange} />
              <SoberanosArsTamarTable flows={filteredDetailsData} activeTab={activeTab} />
            </TabsContent>
          </Tabs>
        )}
      </div>
