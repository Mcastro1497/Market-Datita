...
import { CalendarIcon, X, Search, Link2 } from "lucide-react"
import { format } from "date-fns"
import { es } from "date-fns/locale"

interface DlkDetailsFiltersProps {
...
const STORAGE_KEY = "dlkDetailsFilters"

export function DlkDetailsFilters({
  legislaciones,
  jurisdicciones,
  emisores,
  onFiltersChange,
}: DlkDetailsFiltersProps) {
