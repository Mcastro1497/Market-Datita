...
interface SoberanosArsTamarTableProps {
  flows: SoberanoWithDetails[]
  activeTab: string
}

export function SoberanosArsTamarTable({ flows, activeTab }: SoberanosArsTamarTableProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs text-muted-foreground text-center">
        Mantén Shift + rueda del mouse para desplazarte horizontalmente • Mostrando {filteredAndSortedFlows.length} de {flows.length} registros TAMAR
      </div>
    </div>
  )
}
