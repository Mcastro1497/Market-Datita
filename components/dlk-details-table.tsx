  ...
  return (
    <div className="space-y-4">
          ...
          <TableBody>
            {filteredAndSortedFlows.map((flow) => (
              <TableRow key={flow.id}>
                ...
                <TableCell className="text-center bg-rose-50">
                  {flow.details?.calleable !== undefined && flow.details?.calleable !== null ? (
      ...
      <div className="text-xs text-muted-foreground text-center">
        Mantén Shift + rueda del mouse para desplazarte horizontalmente • Mostrando {filteredAndSortedFlows.length} de {flows.length} bonos Dólar Linked
