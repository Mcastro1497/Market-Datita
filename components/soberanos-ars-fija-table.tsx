...
interface SoberanosArsFijaTableProps {
  flows: SoberanoWithDetails[]
  activeTab: string
}

export function SoberanosArsFijaTable({ flows, activeTab }: SoberanosArsFijaTableProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="bg-lb-green/10 border border-lb-green/30 rounded-lg p-4">
        <div className="flex items-center gap-2 mb-2">
          <PiggyBank className="h-5 w-5 text-lb-green" />
